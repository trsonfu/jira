...
import { Avatar_02, Avatar_05, Avatar_09, Avatar_10, Avatar_16, eye, icon01, icon02, icon03, icon05, img1, img2, img3, img4, key } from '../../../Entryfile/imagepath'
            ...
            <div className="page-wrapper">
                ...
                <div className="content container-fluid">
                        ...
                        <div className="row user-tabs">
                            <div className="col-lg-12 col-md-12 col-sm-12 line-tabs">
                                <ul className="nav nav-tabs nav-tabs-bottom">
                                    <li className="nav-item"><a href="#emp_profile" data-bs-toggle="tab" className="nav-link">Profile</a></li>
                                    ...
                                    <li className="nav-item"><a href="#user_assets" data-bs-toggle="tab" className="nav-link active">Assets</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div className="tab-content">
                        ...
                        <div id="user_assets" className="pro-overview tab-pane fade show active">
                            <div className="user_asset">
                                <div className="assign-head">
                                    ...
                                    <div className="assign-content">
                                        <Link to="#" className="btn btn-assign" data-bs-toggle="modal" data-bs-target="#raise-issue"><i className="fas fa-hand-paper" /> Raise Issue</Link>
                                    </div>
                                </div>
                            ...
                            <div className="modal-body">
                                <form>
                                    ...
                                    <div className="submit-section mt-0">
                                        <button className="btn btn-primary submit-btn w-100">Submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
