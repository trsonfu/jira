                         ...
                         <div className="row">
                           ...
                           <div className="col-md-6">
                             <div className="form-group">
                               ...
                               <select className="select" style={{width:210 , height:40 ,borderRadius:'5px',borderColor:'#D7D5D1'}}> 
                           ...
                           <div className="col-md-6">
                             <div className="form-group">
                               <label>No of Users</label><br/>
                               <select className="select" style={{height: 40,
    width: 212,borderRadius:'5px',borderColor:'#D7D5D1' }}> 
