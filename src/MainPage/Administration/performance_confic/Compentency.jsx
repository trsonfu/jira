                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td className="text-center">
                                    ...
                                    <a href="https://newhrms.com/newhrms_stagging/settings/delete_performance_competency/6" className="text-danger" data-bs-toggle="ajaxModal" data-original-title="Delete"><i className="fa fa-times" /></a>
                                  </td>
                                </tr>
                                <tr>
                                  <th>
                                  ...
                                  <td className="text-center">
                                    ...
                                    <a href="https://newhrms.com/newhrms_stagging/settings/delete_performance_competency/7" className="text-danger" data-bs-toggle="ajaxModal" data-original-title="Delete"><i className="fa fa-times" /></a>
                                  </td>
                                </tr>
                                <tr>
                                  <th>
                                  ...
                                  <td className="text-center">
                                    ...
                                    <a href="https://newhrms.com/newhrms_stagging/settings/delete_performance_competency/8" className="text-danger" data-bs-toggle="ajaxModal" data-original-title="Delete"><i className="fa fa-times" /></a>
                                  </td>
                                </tr>
                                <tr>
                                  <th>
                                  ...
                                  <td className="text-center">
                                    ...
                                    <a href="https://newhrms.com/newhrms_stagging/settings/delete_performance_competency/9" className="text-danger" data-bs-toggle="ajaxModal" data-original-title="Delete"><i className="fa fa-times" /></a>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td style={{paddingRight: 0, minWidth: 55, maxWidth: 55, width: 55}}>
                                      <button type="button" className="btn btn-white add_competency_performance" data-bs-toggle="tooltip" data-original-title="Add Competency" style={{height: 44, fontSize: 16, padding: '10px 15px'}}><i className="fa fa-plus-circle" /></button>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
