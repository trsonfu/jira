                      ...
                      <div className="row">
                        ...
                        <div className="col-md-4 mb-3">
                          ...
                          <div className="input-group">
                            ...
                            <input type="text" className="form-control is-invalid" id="validationServerUsername" placeholder="Username" aria-describedby="inputGroupPrepend3" required style={{ borderRadius: 5 }} />
                            <div className="invalid-feedback">
                              Please choose a username.
                            </div>
                          </div>
                    ...
                    <div className="col-sm">
                      <form className="was-validated">
                        <div className="custom-control custom-checkbox mb-3">
                          ...
                          <label className="custom-control-label set-marg" htmlFor="customControlValidation1" >Check this custom checkbox</label>
                        ...
                        <div className="custom-control custom-radio">
                          ...
                          <label className="custom-control-label set-marg" htmlFor="customControlValidation2" >Toggle this custom radio</label>
                        </div>
                        <div className="custom-control custom-radio mb-3">
                          <input type="radio" className="custom-control-input" id="customControlValidation3" name="radio-stacked" required />
                          <label className="custom-control-label set-marg" htmlFor="customControlValidation3">Or toggle this other custom radio</label>
                        ...
                        <div className="form-group">
                          ...
                          <div className="form-control set-border">
                            ...
                            <div className="invalid-feedback" style={{ marginTop: 12, marginLeft: -10, borderColor: 'red' }}>Example invalid custom file feedback</div>
                          </div>
                        </div>
                      </form>
                    </div>
